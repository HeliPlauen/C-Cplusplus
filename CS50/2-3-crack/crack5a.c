...
int main (int argc, char *argv[])
{
    ...
    char text[] = "AAAAA";
    char symbol_1, symbol_2, symbol_3, symbol_4, symbol_5;
    ...
    do
    {
        ...
        do
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    // if the 2-nd letter is ont a letter
                    if (!isalpha(text[1]))
                    {
                        text[1] = 'a' - 1;
                    }
                ...
                // if the 3-rd letter is ont a letter
                if (!isalpha(text[2]))
                {
                    text[2] = 'a' - 1;
                }
            ...
            // if the 4-th letter is ont a letter
            if (!isalpha(text[3]))
            {
                text[3] = 'a' - 1;
            }
        ...
        // if the 5-th letter is ont a letter
        if (!isalpha(text[4]))
        {
            text[4] = 'a' - 1;
        }
        ...
        // creating the temporary char for the 5-th loop
        symbol_5 = text[4] + 1;
